...
assets/
  css/
    ...
    overrides.css       # shared cards, buttons, drill option lists
  js/
...
Study notes for the GCP Professional Data Engineer exam. Google's official exam guide and sample questions remain Google's; everything else is original study material.
